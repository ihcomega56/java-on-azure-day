...
public class ReservationServiceTest {
    ...
    public void testReserveTicket_売り切れ時例外発生() throws SoldOutException {
        ...
        // Then - SoldOutExceptionが発生することを期待
    }

    @Test(expected = SoldOutException.class)
    public void testReserveTicket_存在しないイベント時例外発生() throws SoldOutException {
    ...
    public void testCancelReservation_正常キャンセル() {
        ...
        verify(reservationDAO).updateReservation(testReservation);
    ...
    public void testGetReservationByConfirmationCode_正常取得() {
        ...
        when(reservationDAO.getReservationByConfirmationCode(confirmationCode)).thenReturn(testReservation);
        ...
        verify(reservationDAO).getReservationByConfirmationCode(confirmationCode);
    }
    ...
    public void testGetReservationsByEmail_正常取得() {
        ...
        when(reservationDAO.getReservationsByEmail(email)).thenReturn(expectedReservations);
